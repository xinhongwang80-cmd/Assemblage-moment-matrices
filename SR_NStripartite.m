function [y1,y2] = SR_NStripartite(assemblage)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SR_NStripartite.m Compute the steering robustness of the given
% assemblage with respect to the no-signaling LHS model, where 
% Alice and Bob steer Charlie.
%
%   assemblage: the assemblage created by a set of Alice and Bob's POVMs
